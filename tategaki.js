...
$(function() {
		...
		switch (keycode) {
			...
			case 38:
				...
				if (e.shiftKey) {
					...
					var $prevSelectConvertView = $('.convert-view.select');
	...
	function addDisplayChar(first) {
		...
		for (var i=0,cnt=displayRow.length;i<cnt;i++) {
			...
			addArr.concat(ret.add);
			removeArr.concat(ret.remove);
		}
	...
	function moveFile($file,$newParentDir) {
		"use strict";
		var fileID;
		var newParentDirID;
