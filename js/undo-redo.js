 ...
 */
class DoManager {  // jshint ignore:line
    //{{{
    // constructor {{{
    /**
 ...
 */
class PrintDoMemory extends DoMemory {  // jshint ignore:line
    //{{{
 ...
 */
class DeleteDoMemory extends DoMemory {  // jshint ignore:line
    //{{{
...
class LineBreakDoMemory extends DoMemory {  // jshint ignore:line
    //{{{
...
class ColorDoMemory extends DoMemory {  // jshint ignore:line
    //{{{
    /**
...
class ItalicDoMemory extends DoMemory {  // jshint ignore:line
    //{{{
    /**
...
class BoldDoMemory extends DoMemory {  // jshint ignore:line
    //{{{
    /**
     * このクラスでは古い状態も情報として必要となるので、必ず文字の変更前に作成してください
...
class FontSizeDoMemory extends DoMemory {  // jshint ignore:line
    //{{{
    /**
     * このクラスでは古い状態も情報として必要となるので、必ず文字の変更前に作成してください
